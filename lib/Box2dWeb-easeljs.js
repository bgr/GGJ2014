...
(function () {
   ...
   b2World.prototype.DrawDebugData = function () {
      ...
      if (this.m_debugDraw.m_sprite.getNumChildren() > 0) {
         this.m_debugDraw.m_sprite.removeAllChildren(); 
         this.m_debugDraw.m_ctx.clear();
      }
      ...
      var shape = new createjs.Shape(this.m_debugDraw.m_ctx);
      this.m_debugDraw.m_sprite.addChild(shape);
   }
...
(function () {
   ...
   b2DebugDraw.b2DebugDraw = function () {
      ...
      not necessary since the m_sprite now already has a clear method from createjs 
   ...
   b2DebugDraw.prototype.SetSprite = function (sprite) {
      ...
      this.m_ctx = new createjs.Graphics();
   };
   b2DebugDraw.prototype.GetSprite = function () {
      return {sprite: this.m_sprite, graphics: this.m_ctx};
   };
   b2DebugDraw.prototype.Clear = function () {
      this.m_sprite.removeAllChildren();
   };
   b2DebugDraw.prototype.SetRGBByHexStrokeColor = function (colorHexString) {
      this.m_hex_stroke_color = colorHexString; 
      var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec( this.m_hex_stroke_color );
      this.m_stroke_rgb = {
   ...
   b2DebugDraw.prototype.SetRGBByHexFillColor = function (colorHexString) {
      this.m_hex_fill_color = colorHexString; 
      var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec( this.m_hex_fill_color );
      this.m_fill_rgb = {
        r: parseInt(result[1], 16),
        g: parseInt(result[2], 16),
        b: parseInt(result[3], 16)
   ...
   b2DebugDraw.prototype.SetAlphaColor = function ( alphaColorNum ) {
      if ( alphaColorNum > 1 ) alphaColorNum / 100; 
      this.m_alpha_color = alphaColorNum; // 0 - 1
   };
    b2DebugDraw.prototype.SetStrokeThickness = function ( strokeThicknessNum ) {
      this.m_stroke_thickness =  strokeThicknessNum;
   };
   b2DebugDraw.prototype.GetSprite = function () {
      return this.m_ctx;
   };
